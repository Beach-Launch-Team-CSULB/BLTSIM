...
Telemetry_BusType = addBusElement(Telemetry_BusType, 'Name', 'lla_deg',       'Dimensions', 3);
Telemetry_BusType = addBusElement(Telemetry_BusType, 'Name', 'bodyRates_rps', 'Dimensions', 3);